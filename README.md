...
┌─────────────────────────────────────────────────────────────┐
│ 🤖 RAG Tabanlı Akıllı Chatbot                              │
│ Retrieval Augmented Generation ile Döküman Bazlı Soru-Cevap │
├─────────────────────────────────────────────────────────────┤
│ ⚙️ Ayarlar                    │ 📚 Döküman Yükleme          │
│ Token: [••••••••]             │ [Dosya Yükleme Alanı]       │
│ Model: Flan-T5-Large          │ [🔄 RAG Sistemi Oluştur]    │
│ Chunk Size: 500               │                             │
│ Temperature: 0.3              │ ℹ️ Durum                    │
│                               │ ✅ Vektör DB: Aktif         │
├─────────────────────────────────────────────────────────────┤
│ 💬 Sohbet                                                    │
│ [Kullanıcı]: Bu dökümanlarda hangi konular var?             │
│ [Asistan]: Bu dökümanlarda şu konular ele alınmış...        │
│ 📚 Kaynaklar (3 adet)                                       │
└─────────────────────────────────────────────────────────────┘
```
...
Video içeriği:
- Proje tanıtımı (0:00-1:00)
- Kurulum adımları (1:00-3:00)
- Döküman yükleme (3:00-4:00)
- RAG sistemi oluşturma (4:00-5:00)
- Soru-cevap örnekleri (5:00-8:00)
- Kaynak gösterimi (8:00-9:00)

### 🔧 Gelişmiş Özellikler

#### Model Karşılaştırması
- **Flan-T5-Large**: Hızlı, genel amaçlı
- **Flan-T5-XL**: Daha büyük, daha doğru
- **Llama-2-7B**: Güçlü, konuşma odaklı
- **Mistral-7B**: Dengeli performans

#### Parametre Optimizasyonu
- **Chunk Size**: 500 (dengeli), 1000 (detaylı), 200 (hızlı)
- **Temperature**: 0.1 (kesin), 0.3 (dengeli), 0.7 (yaratıcı)
- **K Documents**: 3 (standart), 5 (kapsamlı), 1 (hızlı)

### 🚨 Bilinen Sınırlamalar
1. **Token Limiti**: Hugging Face API limitleri
2. **Dosya Boyutu**: Büyük dosyalar için işleme süresi
3. **Model Bağımlılığı**: İnternet bağlantısı gerekli
4. **Dil Desteği**: Türkçe ve İngilizce optimize

### 🔮 Gelecek Geliştirmeler
- [ ] Yerel model desteği
- [ ] Daha fazla dosya formatı
- [ ] Gelişmiş chunking stratejileri
- [ ] Kullanıcı hesapları
- [ ] API endpoint'leri
...
- [LangChain](https://langchain.com/) - RAG framework'ü için
- [Hugging Face](https://huggingface.co/) - LLM modelleri için
- [Streamlit](https://streamlit.io/) - Web arayüzü için
- [FAISS](https://faiss.ai/) - Vektör arama için
